...
SKILL_GRAPH_PATH  = DATA_DIR / "skill_prerequisite_v1.json"
...
# ── 快速通道：跳过技能 ───────────────────────────────────────────────────
FAST_TRACK_SKIP = {
    "RAG应用工程师":   {"sk_math_basic", "sk_stats", "sk_ml_basic", "sk_dl_basic",
                       "sk_data_structure", "sk_ab_test"},
    "Agent应用工程师": {"sk_math_basic", "sk_stats", "sk_ml_basic", "sk_dl_basic",
                       "sk_data_structure", "sk_ab_test"},
    "数据分析师":      set(),
    "后端工程师":      {"sk_math_basic", "sk_stats", "sk_ml_basic"},
}

# ── 最全覆盖：各岗位增补扩展技能（选修，了解技术全貌）────────────────────
ROLE_ENRICHMENT = {
    "RAG应用工程师":   ["sk_transformer", "sk_lora_finetune", "sk_nlp_basic",
                       "sk_pytorch", "sk_dl_basic"],
    "Agent应用工程师": ["sk_rag", "sk_transformer", "sk_nlp_basic",
                       "sk_embedding", "sk_vector_db"],
    "数据分析师":      ["sk_data_structure", "sk_ml_basic"],
    "后端工程师":      ["sk_data_structure", "sk_numpy", "sk_pandas"],
}

# ── 目标岗位核心技能 ─────────────────────────────────────────────────────
TARGET_ROLE_SKILLS = {
    "RAG应用工程师":   ["sk_python_basic", "sk_llm_basic", "sk_prompt_eng",
                       "sk_embedding", "sk_vector_db", "sk_langchain", "sk_rag", "sk_fastapi"],
    "Agent应用工程师": ["sk_python_basic", "sk_llm_basic", "sk_prompt_eng",
                       "sk_langchain", "sk_agent", "sk_tool_use", "sk_fastapi"],
    "数据分析师":      ["sk_python_basic", "sk_sql_basic", "sk_pandas", "sk_numpy",
                       "sk_matplotlib", "sk_stats", "sk_sql_advanced", "sk_tableau", "sk_ab_test"],
    "后端工程师":      ["sk_python_basic", "sk_sql_basic", "sk_git",
                       "sk_linux_basic", "sk_fastapi", "sk_docker"],
}
