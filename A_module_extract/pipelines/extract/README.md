...
如果你是在 `A_module_extract` 汇总包里运行，可以把路径改成：

```bash
python A_module_extract/pipelines/extract/eval_extractor.py --gold A_module_extract/data/silver/profile_labeled_v1.jsonl --mode resume
```
